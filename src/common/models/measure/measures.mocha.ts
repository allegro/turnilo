...
describe("Measures", () => {
  ...
  it("should throw when converting tree with underscore prefix", () => {
    const measureWithForbiddenNames = [{ ...MeasureFixtures.wikiCount(), name: "_name" }];
    expect(() => Measures.fromJS(measureWithForbiddenNames)).to.throw("found measure that starts or ends with underscore: _name");
  });

  it("should throw when converting tree with underscore suffix", () => {
    const measureWithForbiddenNames = [{ ...MeasureFixtures.wikiCount(), name: "name_" }];
    expect(() => Measures.fromJS(measureWithForbiddenNames)).to.throw("found measure that starts or ends with underscore: name_");
  });
