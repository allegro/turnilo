...
import { ExpressionSeriesOperation, ExpressionValue } from "./expression";

type Operations = ExpressionSeriesOperation.ADD
...
export class ExpressionArithmeticOperation extends Record<ExpressionArithmeticOperationValue>(defaultExpression) {
