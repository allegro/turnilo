...
// import { OldAppSettings } from "./app-settings";
...
//       js.clusters = [];
//       expect(() => OldAppSettings.fromJS(js, context)).to.throw("Can not find cluster 'druid-wiki' for data cube 'wiki'");
//     });
//
//   });
//
...
//       expect(OldAppSettings.fromJS(oldJS, context).toJS()).to.deep.equal(AppSettingsFixtures.wikiOnlyJS());
//     });
//
...
//       };
//
//       expect(OldAppSettings.fromJS(oldJS, context).toJS().clusters).to.deep.equal([
//         {
//           name: "druid",
//           type: "druid",
//           host: "192.168.99.100",
...
//   describe("general", () => {
//     it("blank", () => {
//       expect(OldAppSettings.BLANK.toJS()).to.deep.equal({
//         clusters: [],
//         customization: {},
//         dataCubes: [],
//         clientTimeout: 0
