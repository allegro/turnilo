...
function turniloRouter(settingsGetter, version) {
    var _this = this;
    var router = express_1.Router();
    router.get("/", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var settings, clientSettings, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, settingsGetter()];
                case 1:
                    settings = _a.sent();
                    clientSettings = settings.toClientSettings();
                    clientSettings.dataCubes = clientSettings.dataCubes.filter(function (dataCube) { return datacube_guard_1.checkAccess(dataCube, req.headers); });
